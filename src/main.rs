...
use shuttle_runtime::SecretStore; // Note: Using runtime's SecretStore now

mod routes;

#[shuttle_runtime::main]
async fn main(
    #[shuttle_runtime::Secrets] secrets: SecretStore, // Changed attribute
    ...
    let config = move |cfg: &mut ServiceConfig| {
        ...
        cfg.service(routes::index::hello_world);
